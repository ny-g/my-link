      ...
      <div className="relative z-10 w-full max-w-[480px] flex flex-col gap-8">
        ...
        <div className="flex flex-col items-center justify-center text-center px-4 mt-4">
          <div className="relative mb-8 group">
            {/* Animated Glow Ring */}
            <div className="absolute -inset-2 rounded-full bg-gradient-to-r from-primary via-blue-500 to-purple-600 opacity-70 blur-md transition-opacity duration-500 animate-pulse"></div>
            {/* Avatar Container */}
